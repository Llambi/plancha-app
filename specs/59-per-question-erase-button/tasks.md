...
- [ ] **T1 — `clearAnswer()` en `practica-progress.ts` (rojo → verde)**
...
- [ ] **T2 — `clearAnswer()` en `desarrollo-progress.ts` (rojo → verde)**
...
- [ ] **T3 — E2E rojo: botón de borrar en preguntas de test**
...
- [ ] **T4 — Implementar el botón de borrar en `TestQuestion.astro`**
...
- [ ] **T5 — E2E rojo: botón de borrar en preguntas de desarrollo**
...
- [ ] **T6 — Implementar el botón de borrar en `DesarrolloQuestion.astro`**
